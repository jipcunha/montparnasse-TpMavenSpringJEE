package com.infotel.TpMavenSpringJEE.servlet;
...
import com.infotel.TpMavenSpringJEE.service.Iservice;
import com.infotel.TpMavenSpringJEE.service.ServiceImpl;
...
ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("applicationContext.xml");   
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Personne p = service.afficherPersonne(Integer.parseInt(request.getParameter("idPers"))); //idPers vient de la jsp
